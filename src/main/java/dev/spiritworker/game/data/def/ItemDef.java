...
public class ItemDef extends ResourceDef {
	...
	{
		return  "id : " + getId() + "\nName : " + name + "\nmaxUpgrades : " + upgradesMax + "\nreqLvl : " + levelReq +
				"\ns : " + s +
				"\n\nstatId1 : " + statId1 + " = " + statValue1 +
				"\nstatId2 : " + statId2 + " = " + statValue2 +
				"\nstatId3 : " + statId3 + " = " + statValue3 +
				"\nstatId4 : " + statId4 + " = " + statValue4 +
				"\nstatId5 : " + statId5 + " = " + statValue5 +
				"\ngetDamageMin : " + getDamageMin() + "\ngetDamageMax : " + getDamageMax() +
				"\ngetDefenceMin : " + getDefenceMin() + "\ngetDefenceMax : " + getDefenceMax() +
